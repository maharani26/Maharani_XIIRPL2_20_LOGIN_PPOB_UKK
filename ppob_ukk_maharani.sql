...
--
-- Host: 127.0.0.1
-- Generation Time: 23 Okt 2019 pada 07.40
...
CREATE TABLE `penggunaan` (
  ...
  `meter_akhir` mediumtext NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
ALTER TABLE `tagihan`
  ...
  ADD KEY `id_pengunaan` (`id_pengunaan`);
...
--
ALTER TABLE `tagihan`
  ADD CONSTRAINT `tagihan_ibfk_1` FOREIGN KEY (`id_pengunaan`) REFERENCES `penggunaan` (`id_penggunaan`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
